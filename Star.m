...
% Force mode
%FDef = 50; EY = 3e3; t = 0.27; Ls = 50; EY2 = 3e3; Ls2 = Ls; D_lmd = 0.00000005; interv = 20; %Paper
FDef = 0.5; EY = 10; t = 1; Ls = 50; EY2 = 30; Ls2 = Ls; D_lmd = 0.0000002; interv = 25; %LASMP
...
%% Plot representational scheme
    ...
    view(-2,16)
    rotate3d on
    title('Star','fontsize',14,'fontweight','normal');
